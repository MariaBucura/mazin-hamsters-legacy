...
public class LongStraightTube : Tube
{
    ...
    public LongStraightTube(GameObject model, Mesh mesh, Vector3 position, Quaternion rotation, Vector3 scale, bool endpoint1, bool endpoint2)
        : base(model, mesh, position, rotation, scale)
    {
        this.endpoint1 = endpoint1;
        this.endpoint2 = endpoint2;
        category = "straightTube";
    }
    ...
    public override void Instantiate()
    {
        ...
        modelInstance.transform.rotation = Quaternion.Euler(-90, 180, 0);
        ...
        if (!endpoint1)
        {
            ...
            startRing = ring1;
            endpoint1 = true;
            Vector3 snapPoint1 = ringPosition1;
            snapPoint1.z -= 0.7f;
            generateSnapPoints(startRing.instance, out snapPointA1, out snapPointA2, snapPoint1);
            startRing.instance.transform.parent = instance.transform;
        }
        else
        {
            generateSnapPoints(instance, out snapPointA1, out snapPointA2, ringPosition1);
        }
    ...
    public void Rotate()
    {
        instance.transform.Rotate(instance.transform.up, 90f, Space.World);
    }
}
